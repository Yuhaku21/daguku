...
<head>
  ...
  <title>Kelola Ambil Orderan</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous" />
</head>
<body>
  <div class="container mt-5">
    <h1>Kelola Ambil Orderan</h1>
    ...
    <table class="table table-dark">
      <thead>
        <tr>
          ...
          <th scope="col">Aksi</th> <!-- Kolom aksi ditampilkan kembali -->
        </tr>
      </thead>
      <tbody>
        <?php
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<td>" . htmlspecialchars($row['no_whatsapp']) . "</td>"; // Menggunakan htmlspecialchars untuk mencegah serangan XSS
          // Tombol edit dan hapus ditampilkan kembali
          echo "<td>";
          echo "<a href='ambil-edit.php?id=" . $row['id'] . "' class='btn btn-primary btn-sm'>Edit</a> ";
          echo "<a href='ambil_hapus.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Hapus</a>";
          echo "</td>";
          echo "</tr>";
        }
